...
def main():
    ...
    width_values = [0.1, 0.2, 0.3, 0.5, 0.7, 1]
    bin_values = [5, 10, 15, 20, 30]
    component_values = [3, 5, 7, 9, 10, 12]
    pca_component_values = [1, 2]
    tolerance_values = [1e-2, 1e-3, 1e-4]
    contamination_values = [0.05, 0.1, 0.15, 0.2, 0.25, 0.3]
    neighbor_values = [3, 5, 7, 10, 15, 20]
    perplexity_values = [2, 3, 4.5, 5, 7, 10]
    cut_values = [50, 100, 150, 200]
    ...
    for regime in regimes:
        ...
        for contaminate in noise_contamination:
            ...
            for split_name, file_ids in [("Train", train_file_ids)]:
                ...
                for i in file_ids:
                    ...
                    if regime == "All" and contaminate == 50 and i == 9:
                        plt.figure()
                    ...
                    for model in outlier_models:
                        ...
                        if model == "KDE":
                            ...
                            param_values = (contamination_values, width_values)
                        elif model == "GMM":
                            input_param = "component, tolerance"
                            param_values = (component_values, tolerance_values)
                        elif model == "HBOS":
                            input_param = "contamination, bin"
                            param_values = (contamination_values, bin_values)
                        elif model == "COPOD":
                            input_param = "contamination"
                            param_values = contamination_values
                        elif model == "ECOD":
                            input_param = "contamination"
                            param_values = contamination_values
                            ...
                            param_values = (contamination_values, pca_component_values)
                        elif model == "KPCA":
                            input_param = "contamination, component"
                            param_values = (contamination_values, pca_component_values)
                            ...
                            param_values = (contamination_values, neighbor_values)
                        elif model == "COF":
                            input_param = "contamination, neighbor"
                            param_values = (contamination_values, neighbor_values)
                        elif model == "KNN":
                            ...
                            param_values = (contamination_values, perplexity_values)
                        
                        elif model == "FB":
                            input_param = "estimator, contamination"
                            param_values = (neighbor_values, contamination_values)
                        elif model == "IF":
                            input_param = "contamination"
                            param_values = contamination_values
                        elif model == "LODA":
                            input_param = "contamination, bin, cut"
                            param_values = (contamination_values, bin_values, cut_values)
                        elif model == "INNE":
                            input_param = "contamination"
                            param_values = contamination_values
                        elif model == "DIF":
